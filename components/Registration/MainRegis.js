...
export default function MainRegis() {
  ...
  return (
    <Container>
      <div className="relative xl:pb-[114px] shadow-[10px_40px_50px_#F3F3F3] md:mt-[253px] mt-[183px] xl:mt-[374px] xl:px-[52px] xl:pt-[72px]  md:px-10 px-5 md:py-[60px] py-10 xl:w-10/12 md:w-9/12 w-full mx-auto xl:mb-[205px] bg-white">
